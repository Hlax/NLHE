...
NLHE_API UScriptStruct* Z_Construct_UScriptStruct_FDeck();
...
class UScriptStruct* FDeck::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Deck.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FDeck, (UObject*)Z_Construct_UPackage__Script_NLHE(), TEXT("Deck"));
	}
	return Z_Registration_Info_UScriptStruct_Deck.OuterSingleton;
}
template<> NLHE_API UScriptStruct* StaticStruct<FDeck>()
{
...
const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FDeck_Statics::NewProp_Cards_Inner = { "Cards", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UScriptStruct_FCard, METADATA_PARAMS(0, nullptr) }; // 2470277742
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FDeck_Statics::NewProp_Cards = { "Cards", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FDeck, Cards), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Cards_MetaData), NewProp_Cards_MetaData) }; // 2470277742
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Deck_h_Statics
{
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FDeck::StaticStruct, Z_Construct_UScriptStruct_FDeck_Statics::NewStructOps, TEXT("Deck"), &Z_Registration_Info_UScriptStruct_Deck, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDeck), 1433475303U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Deck_h_1394385593(TEXT("/Script/NLHE"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Deck_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Deck_h_Statics::ScriptStructInfo),
	nullptr, 0);
// End Registration
