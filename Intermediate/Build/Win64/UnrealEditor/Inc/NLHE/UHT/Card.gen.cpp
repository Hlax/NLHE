...
NLHE_API UEnum* Z_Construct_UEnum_NLHE_ERank();
NLHE_API UEnum* Z_Construct_UEnum_NLHE_ESuit();
...
static UEnum* ESuit_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ESuit.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_NLHE_ESuit, (UObject*)Z_Construct_UPackage__Script_NLHE(), TEXT("ESuit"));
	}
	return Z_Registration_Info_UEnum_ESuit.OuterSingleton;
}
template<> NLHE_API UEnum* StaticEnum<ESuit>()
{
	return ESuit_StaticEnum();
}
struct Z_Construct_UEnum_NLHE_ESuit_Statics
{
#if WITH_METADATA
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NLHE_ESuit_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_NLHE,
	nullptr,
	"ESuit",
	"ESuit",
	Z_Construct_UEnum_NLHE_ESuit_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_NLHE_ESuit_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NLHE_ESuit_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NLHE_ESuit_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_NLHE_ESuit()
{
	if (!Z_Registration_Info_UEnum_ESuit.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ESuit.InnerSingleton, Z_Construct_UEnum_NLHE_ESuit_Statics::EnumParams);
	}
...
static UEnum* ERank_StaticEnum()
{
	...
	{
		Z_Registration_Info_UEnum_ERank.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_NLHE_ERank, (UObject*)Z_Construct_UPackage__Script_NLHE(), TEXT("ERank"));
	}
	return Z_Registration_Info_UEnum_ERank.OuterSingleton;
}
template<> NLHE_API UEnum* StaticEnum<ERank>()
{
	return ERank_StaticEnum();
}
struct Z_Construct_UEnum_NLHE_ERank_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[] = {
		{ "Ace.DisplayName", "Ace" },
...
const UECodeGen_Private::FEnumParams Z_Construct_UEnum_NLHE_ERank_Statics::EnumParams = {
	(UObject*(*)())Z_Construct_UPackage__Script_NLHE,
	nullptr,
	"ERank",
	"ERank",
	Z_Construct_UEnum_NLHE_ERank_Statics::Enumerators,
	RF_Public|RF_Transient|RF_MarkAsNative,
	UE_ARRAY_COUNT(Z_Construct_UEnum_NLHE_ERank_Statics::Enumerators),
	EEnumFlags::None,
	(uint8)UEnum::ECppForm::EnumClass,
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UEnum_NLHE_ERank_Statics::Enum_MetaDataParams), Z_Construct_UEnum_NLHE_ERank_Statics::Enum_MetaDataParams)
};
UEnum* Z_Construct_UEnum_NLHE_ERank()
{
	if (!Z_Registration_Info_UEnum_ERank.InnerSingleton)
	{
		UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ERank.InnerSingleton, Z_Construct_UEnum_NLHE_ERank_Statics::EnumParams);
	}
...
class UScriptStruct* FCard::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_Card.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCard, (UObject*)Z_Construct_UPackage__Script_NLHE(), TEXT("Card"));
	}
	return Z_Registration_Info_UScriptStruct_Card.OuterSingleton;
}
template<> NLHE_API UScriptStruct* StaticStruct<FCard>()
{
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCard_Statics::NewProp_Suit = { "Suit", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCard, Suit), Z_Construct_UEnum_NLHE_ESuit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Suit_MetaData), NewProp_Suit_MetaData) }; // 677529712
...
const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FCard_Statics::NewProp_Rank = { "Rank", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FCard, Rank), Z_Construct_UEnum_NLHE_ERank, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Rank_MetaData), NewProp_Rank_MetaData) }; // 3742480930
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Card_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ ESuit_StaticEnum, TEXT("ESuit"), &Z_Registration_Info_UEnum_ESuit, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 677529712U) },
		{ ERank_StaticEnum, TEXT("ERank"), &Z_Registration_Info_UEnum_ERank, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3742480930U) },
	};
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		{ FCard::StaticStruct, Z_Construct_UScriptStruct_FCard_Statics::NewStructOps, TEXT("Card"), &Z_Registration_Info_UScriptStruct_Card, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCard), 2470277742U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Card_h_2180437317(TEXT("/Script/NLHE"),
	nullptr, 0,
	Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Card_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Card_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Card_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_guestt_OneDrive_Documents_Unreal_Projects_NLHE_Source_NLHE_Public_Card_h_Statics::EnumInfo));
// End Registration
